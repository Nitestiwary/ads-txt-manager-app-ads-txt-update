...
class Ads_Txt_Admin {
	...
	public function render_dashboard() {
		...
		// Branding Assets support
		$logo_url = ADS_TXT_MANAGER_URL . 'assets/images/logo.png';
		$banner_web = ADS_TXT_MANAGER_URL . 'assets/images/banner-web.png';
		$banner_app = ADS_TXT_MANAGER_URL . 'assets/images/banner-app.png';
