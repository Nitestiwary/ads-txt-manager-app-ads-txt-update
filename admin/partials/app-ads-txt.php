...
<div class="atm-section-header">
	<h2><span class="dashicons dashicons-phone"></span> <?php esc_html_e( 'Manage app-ads.txt', 'ads-txt-manager' ); ?></h2>
	<p class="atm-section-desc">
		<?php esc_html_e( 'Customize your mobile application app-ads.txt file. Make sure entries align with Google AdMob, AppLovin, Unity Ads, etc.', 'ads-txt-manager' ); ?>
	</p>
</div>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="atm-app-ads-txt-form">
		...
		<div class="atm-textarea-wrapper">
			<label for="app_ads_txt_content" class="atm-input-label">
				<?php esc_html_e( 'Edit app-ads.txt lines:', 'ads-txt-manager' ); ?>
				<span class="atm-preview-link-hint">
					(<?php esc_html_e( 'Live Preview URL:', 'ads-txt-manager' ); ?> <a href="<?php echo esc_url( $stats['app_ads']['url'] ); ?>" target="_blank"><?php echo esc_url( $stats['app_ads']['url'] ); ?></a>)
				</span>
			</label>
			<textarea 
			...
			><?php echo esc_textarea( $app_ads_content ); ?></textarea>
		</div>
