...
<div class="atm-section-header">
	<h2><span class="dashicons dashicons-phone"></span> <?php esc_html_e( 'Manage app-ads.txt', 'monetiscope-seller-records' ); ?></h2>
	<p class="atm-section-desc">
		<?php esc_html_e( 'Customize your mobile application app-ads.txt file. Make sure entries align with Google AdMob, AppLovin, Unity Ads, etc.', 'monetiscope-seller-records' ); ?>
	</p>
</div>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="atm-app-ads-txt-form">
		...
		<div class="atm-textarea-wrapper">
			<label for="app_ads_txt_content" class="atm-input-label">
				<?php esc_html_e( 'Edit app-ads.txt lines:', 'monetiscope-seller-records' ); ?>
				<span class="atm-preview-link-hint">
					(<?php esc_html_e( 'Live Preview URL:', 'monetiscope-seller-records' ); ?> <a href="<?php echo esc_url( $stats['app_ads']['url'] ); ?>" target="_blank"><?php echo esc_url( $stats['app_ads']['url'] ); ?></a>)
				</span>
			</label>
			<textarea 
		...
		<div class="atm-form-actions">
			<button type="submit" class="button button-primary button-hero atm-submit-btn">
				<?php esc_html_e( 'Save App-ads.txt Changes', 'monetiscope-seller-records' ); ?>
			</button>
		</div>
	</form>
</div>
