...
<div class="wrap ads-txt-manager-wrap">
	...
	<h1 class="screen-reader-text"><?php esc_html_e( 'Seller Records - Ads.txt Manager & app-ads.txt', 'ads-txt-manager-app-ads-txt-update' ); ?></h1>
	...
	<div class="atm-header-card">
		<div class="atm-header-left">
			...
			<div class="atm-header-title-wrapper">
				<h2 class="atm-main-title" style="color:#ffffff !important;font-size:26px;font-weight:700;margin:0 0 4px 0;padding:0;line-height:1.2;"><?php esc_html_e( 'Seller Records', 'ads-txt-manager-app-ads-txt-update' ); ?></h2>
