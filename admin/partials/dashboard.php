				...
				<div class="atm-dashboard-grid">
					...
					<div class="atm-card">
						...
						<div class="atm-card-body">
							...
							<div class="atm-card-actions">
								<a href="?page=ads-txt-manager&tab=ads-txt" class="atm-button button-primary"><?php esc_html_e( 'Manage Ads.txt', 'ads-txt-manager-app-ads-txt-update' ); ?></a>
							</div>
						</div>
					</div>
					...
					<div class="atm-card">
						...
						<div class="atm-card-body">
							...
							<div class="atm-card-actions">
								<a href="?page=ads-txt-manager&tab=app-ads-txt" class="atm-button button-primary"><?php esc_html_e( 'Manage App-ads.txt', 'ads-txt-manager-app-ads-txt-update' ); ?></a>
							</div>
						</div>
					</div>
				</div>
