...
$enable_validation = isset( $settings['enable_validation'] ) ? $settings['enable_validation'] : '1';
$enable_backup = isset( $settings['enable_backup'] ) ? $settings['enable_backup'] : '1';
$auto_validation = isset( $settings['auto_validation'] ) ? $settings['auto_validation'] : '1';
$duplicate_warning = isset( $settings['duplicate_warning'] ) ? $settings['duplicate_warning'] : '1';
?>
