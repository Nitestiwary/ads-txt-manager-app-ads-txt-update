	...
	<div class="atm-card">
		<div class="atm-card-header">
			...
			<span class="atm-status-badge <?php echo $ads_txt_manager_ads_validation['valid'] && empty( $ads_txt_manager_ads_warnings ) ? 'status-active' : 'status-inactive'; ?>">
				<?php echo $ads_txt_manager_ads_validation['valid'] && empty( $ads_txt_manager_ads_warnings ) ? esc_html__( '100% Valid', 'ads.txt-main' ) : esc_html__( 'Action Needed', 'ads.txt-main' ); ?>
			</span>
		</div>
		<div class="atm-card-body">
			<ul class="atm-bullets">
				...
				<li><strong><?php esc_html_e( 'Syntax Errors:', 'ads.txt-main' ); ?></strong> <span class="<?php echo ! empty( $ads_txt_manager_ads_errors ) ? 'text-danger font-bold' : ''; ?>"><?php echo count( $ads_txt_manager_ads_errors ); ?></span></li>
	...
	<div class="atm-card">
		<div class="atm-card-header">
			...
			<span class="atm-status-badge <?php echo $ads_txt_manager_app_ads_validation['valid'] && empty( $ads_txt_manager_app_warnings ) ? 'status-active' : 'status-inactive'; ?>">
				<?php echo $ads_txt_manager_app_ads_validation['valid'] && empty( $ads_txt_manager_app_warnings ) ? esc_html__( '100% Valid', 'ads.txt-main' ) : esc_html__( 'Action Needed', 'ads.txt-main' ); ?>
			</span>
		</div>
		<div class="atm-card-body">
			<ul class="atm-bullets">
				...
				<li><strong><?php esc_html_e( 'Syntax Errors:', 'ads.txt-main' ); ?></strong> <span class="<?php echo ! empty( $ads_txt_manager_app_errors ) ? 'text-danger font-bold' : ''; ?>"><?php echo count( $ads_txt_manager_app_errors ); ?></span></li>
