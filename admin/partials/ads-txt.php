...
<div class="atm-section-header">
	<h2><span class="dashicons dashicons-admin-site"></span> <?php esc_html_e( 'Manage ads.txt', 'monetiscope-seller-records' ); ?></h2>
	<p class="atm-section-desc">
		<?php esc_html_e( 'Customize your web ads.txt file. Make sure your seller lines are perfectly formatted to prevent loss of ad revenue.', 'monetiscope-seller-records' ); ?>
	</p>
</div>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="atm-ads-txt-form">
		...
		<div class="atm-textarea-wrapper">
			<label for="ads_txt_content" class="atm-input-label">
				<?php esc_html_e( 'Edit ads.txt lines:', 'monetiscope-seller-records' ); ?>
				<span class="atm-preview-link-hint">
					(<?php esc_html_e( 'Live Preview URL:', 'monetiscope-seller-records' ); ?> <a href="<?php echo esc_url( $stats['ads']['url'] ); ?>" target="_blank"><?php echo esc_url( $stats['ads']['url'] ); ?></a>)
				</span>
			</label>
			<textarea 
		...
		<div id="atm-live-validation-result" class="atm-live-validation-box hidden">
			<div class="atm-validation-header">
				...
				<h3><?php esc_html_e( 'Live Validation Analysis', 'monetiscope-seller-records' ); ?></h3>
			</div>
		...
		<div class="atm-form-actions">
			<button type="submit" class="button button-primary button-hero atm-submit-btn">
				<?php esc_html_e( 'Save Ads.txt Changes', 'monetiscope-seller-records' ); ?>
			</button>
		</div>
	</form>
</div>
